...
seq 1 10 | xargs -n1 -P10 bash -c 'log_with_timestamp "Request #{}: $(curl -s -o /dev/null -w "%{http_code}" -X POST -H "Content-Type: application/json" -d "5" http://localhost:8080/counters/66d18233d47f877b4225825c)"'
done
